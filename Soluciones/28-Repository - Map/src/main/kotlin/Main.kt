...
import dev.joseluisgs.repositories.EstudiantesRepositoryMapImpl

fun main() {
    // val repository: EstudiantesRepository = EstudiantesRepositoryListImpl()
    val repository: EstudiantesRepository = EstudiantesRepositoryMapImpl()
    ...
    // Borramos a 15
    (10..15).forEach {
        repository.delete(it.toLong(), true)
    }
